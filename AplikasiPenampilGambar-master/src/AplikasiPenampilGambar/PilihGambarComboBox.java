...
public class PilihGambarComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblPanda2.setBackground(new java.awt.Color(255, 255, 255));
        lblPanda2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/panda2.png"))); // NOI18N
        pCardLayout.add(lblPanda2, "1");

        lblPanda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/panda.png"))); // NOI18N
        pCardLayout.add(lblPanda, "2");
        lblPanda.getAccessibleContext().setAccessibleName("");

        lblPanda1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/panda1.png"))); // NOI18N
        pCardLayout.add(lblPanda1, "3");
        lblPanda1.getAccessibleContext().setAccessibleName("");

        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Select -", "PANDA", "PANDA1", "PANDA2" }));
